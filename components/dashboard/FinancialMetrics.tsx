...
import { Investment, FinancialProfile, Portfolio } from "@/types";
  ...
  const metrics = [
    {
      ...
      subtitle: `${portfolio?.investments?.length}টি বিনিয়োগ`,
      icon: "wallet",
      color: theme.colors.primary,
      trend:
        returnPercentage > 0 ? "up" : returnPercentage < 0 ? "down" : "neutral",
    ...
    },
    {
      ...
      color: "#9C27B0",
      trend:
        weightedReturn >= 10 ? "up" : weightedReturn >= 7 ? "neutral" : "down",
      trendValue: "বার্ষিক",
    },
    {
      ...
      color: "#607D8B",
      trend:
        diversityScore >= 50 ? "up" : diversityScore >= 30 ? "neutral" : "down",
    ...
    <View style={styles.scoreContainer}>
      ...
      <View style={styles.scoreBreakdown}>
        <View style={styles.scoreItem}>
          <Text variant="bodySmall" style={styles.scoreItemLabel}>
            সঞ্চয়ের হার
          </Text>
          ...
          <View style={styles.scoreBar}>
            <View
              style={[
                styles.scoreBarFill,
                {
                  width: `${Math.min(emergencyFundMonths * 16.67, 100)}%`,
        ...
        <View style={styles.scoreItem}>
          ...
          <View style={styles.scoreBar}>
            <View
              style={[
                styles.scoreBarFill,
                { width: `${diversityScore}%`, backgroundColor: "#9C27B0" },
              ]}
            />
          </View>
        </View>
          ...
          <View style={styles.scoreBar}>
            <View
              style={[
                ...
                {
                  width: `${Math.min(
                    Math.max(returnPercentage * 5 + 50, 0),
                    100
                  )}%`,
