...
const registerSchema = yup.object().shape({
  ...
  phone: yup
    .string()
    .matches(/^(\+88)?01[3-9]\d{8}$/, "বৈধ বাংলাদেশী মোবাইল নম্বর দিন")
    .transform((value) => value || undefined),
  age: yup.number().min(18, "বয়স ১৮+ হতে হবে").required("বয়স আবশ্যক"),
  gender: yup
    .mixed<"male" | "female" | "other">()
    .oneOf(["male", "female", "other"], "লিঙ্গ নির্বাচন করুন")
    .transform((value) => value || undefined)
    .optional(),
  password: yup
    .string()
  ...
  agreeToTerms: yup
    .boolean()
    .oneOf([true], "শর্তাবলী গ্রহণ করতে হবে")
    .transform((value) => value || undefined)
    .optional(),
            ...
            <View style={styles.checkboxContainer}>
              <View style={styles.checkboxRow}>
                ...
                <Text variant="bodySmall" style={styles.checkboxText}>
                  আমি <Text style={styles.linkText}>ব্যবহারের শর্তাবলী</Text>{" "}
                  গ্রহণ করি
                </Text>
              </View>
              ...
              <View style={styles.checkboxRow}>
                ...
                />
                <Text variant="bodySmall" style={styles.checkboxText}>
                  আমি <Text style={styles.linkText}>গোপনীয়তা নীতি</Text> গ্রহণ
                  করি
                </Text>
              </View>
            </View>
