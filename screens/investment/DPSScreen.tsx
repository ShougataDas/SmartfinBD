...
export default function DPSScreen() {
  ...
  const investment =
    ...
    investmentOptions.find((inv) => inv.type === "dps");
  ...
  const calculateReturns = () => {
    ...
    const maturityAmount =
      amount * (((1 + monthlyRate) ** totalMonths - 1) / monthlyRate);
  ...
  const handleInvest = async () => {
    ...
    try {
      const newInvestment = {
        ...
        investAmount: totalInvestment.toFixed(0),
      ...
      Alert.alert("ত্রুটি", "আপনার DPS অ্যাকাউন্ট খোলা হয়েছে!");
    }
  };
