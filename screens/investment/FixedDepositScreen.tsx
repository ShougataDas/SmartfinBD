        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.structureItem}>
                    ...
                    <Text style={styles.structureValue}>{investment?.expectedReturn.average}% (বার্ষিক)</Text>
                </View>
                <View style={styles.structureItem}>
                ...
                {depositAmount && (
                    <View style={styles.resultsCard}>
                        ...
                        <View style={styles.resultItem}>
                            ...
                            <Text style={styles.resultValue}>{formatCurrency(Number.parseFloat(depositAmount))}</Text>
                        </View>
                        <View style={styles.resultItem}>
                            <Text style={styles.resultLabel}>সুদ ({selectedTenure} বছরে):</Text>
                        ...
                        <View style={styles.rateInfo}>
                            <Text style={styles.rateText}>বার্ষিক সুদের হার: {investment?.expectedReturn.average}%</Text>
                        </View>
                    </View>
                )}
            </View>
