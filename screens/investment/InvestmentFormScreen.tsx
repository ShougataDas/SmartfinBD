...
const investmentSchema = yup.object().shape({
    ...
    monthlyContribution: yup
        ...
        .optional(),   // <-- makes it optional in the shape
            ...
            <View style={styles.container}>
                <Card style={styles.errorCard}>
                    <Card.Content>
                        ...
                        <Text variant="bodyMedium" style={styles.formErrorText}>
    ...
    const renderStep1 = () => (
        <Card style={styles.stepCard}>
            <Card.Content>
                ...
                />
                {errors.amount && (
                    <Text variant="bodySmall" style={styles.formErrorText}>
    ...
    const renderStep2 = () => (
        <Card style={styles.stepCard}>
            <Card.Content>
                ...
                />
                {errors.tenure && (
                    <Text variant="bodySmall" style={styles.errorCardText}>
...
const styles = StyleSheet.create({
    ...
    // Renamed from 'errorText' to 'formErrorText' for form validation errors
    formErrorText: {
    ...
    // Renamed from 'errorText' to 'errorCardText' for error card content
    errorCardText: {
        color: theme.colors.onSurfaceVariant,
        textAlign: 'center',
        marginBottom: spacing.lg,
