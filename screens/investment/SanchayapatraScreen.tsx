  ...
  const handleInvest = async () => {
    ...
    try {
      const newInvestment = {
        ...
        total: (parseInt(investmentAmount) + totalReturn).toFixed(0),
        expectedReturn: totalReturn.toFixed(0),
        expectedMonthlyReturn: monthlyReturn.toFixed(0),
      };
      await addInvestment(newInvestment);
      Alert.alert("সফল", "আপনার সঞ্চয়পত্র বিনিয়োগ সফল হয়েছে!");
    } catch (error) {
      Alert.alert("ত্রুটি", "আপনার সঞ্চয়পত্র বিনিয়োগ সফল হয়েছে!");
    }
  };
          ...
          <View style={styles.resultsCard}>
            ...
            <View style={styles.resultItem}>
              ...
              <Text style={styles.totalValue}>
                {formatCurrency(
                  Number.parseFloat(investmentAmount) + totalReturn
                )}
              </Text>
            </View>
          </View>
