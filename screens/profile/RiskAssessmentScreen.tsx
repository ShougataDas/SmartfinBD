    ...
    options: [
      {
        ...
        label: "কোনো ক্ষতি সহ্য করতে পারি না",
        score: 1,
      },
      {
        value: "conservative",
        label: "সামান্য ক্ষতি সহ্য করতে পারি",
        score: 2,
      },
...
export const RiskAssessmentScreen: React.FC = () => {
  ...
  const calculateRiskScore = () => {
    ...
    setRiskAssessment(assessment, true);
  ...
  const showResults = (tolerance: RiskTolerance, scorePercentage: number) => {
    ...
    const recommendations = {
      [RiskTolerance.Conservative]:
        "সঞ্চয়পত্র, ফিক্সড ডিপোজিট, DPS এর মতো নিরাপদ বিনিয়োগ",
      [RiskTolerance.Moderate]:
        "মিউচুয়াল ফান্ড, সরকারি বন্ড, এবং কিছু শেয়ারের মিশ্রণ",
      [RiskTolerance.Aggressive]:
        "শেয়ার বাজার, গ্রোথ মিউচুয়াল ফান্ড, এবং উচ্চ রিটার্ন বিনিয়োগ",
    };

    Alert.alert(
      "ঝুঁকি মূল্যায়ন সম্পূর্ণ",
      `আপনার ঝুঁকি সহনশীলতা: ${
        toleranceText[tolerance]
      } (${scorePercentage.toFixed(0)}%)\n\nসুপারিশকৃত বিনিয়োগ: ${
        recommendations[tolerance]
      }`,
      [
        {
          text: "ঠিক আছে",
        ...
        <Card style={styles.questionCard}>
          <Card.Content>
            <View style={styles.questionHeader}>
              <Icon name="help-circle" size={40} color={theme.colors.primary} />
        ...
        <Card style={styles.infoCard}>
          <Card.Content>
            ...
            <Text variant="bodyMedium" style={styles.infoText}>
              আপনার ঝুঁকি সহনশীলতা জানা থাকলে আমরা আপনার জন্য সবচেয়ে উপযুক্ত
              বিনিয়োগ পরিকল্পনা তৈরি করতে পারি। এটি আপনার আর্থিক লক্ষ্য অর্জনে
              সাহায্য করবে।
            </Text>
          </Card.Content>
        </Card>
